...
&#x20;  #define LivePT\_EditMode true       // true — активирует режим live-редактирования

&#x20;  #define LivePT\_WheelEditMode true  // true — включает управление мышью и контекстные меню
...
&#x20;  #define LivePT\_EditMode true       // true — enables the live editing infrastructure

&#x20;  #define LivePT\_WheelEditMode true  // true — enables mouse dragging and context menus
